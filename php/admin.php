...
// Manejo seguro de variables de sesión para el header
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* ESTILOS DE LOS BOTONES DEL HEADER (AQUÍ ESTABA EL PROBLEMA) */
        .header-right {
            display: flex;
            align-items: center;
            gap: 20px;
        ...
        /* RESTO DEL DISEÑO (Tarjetas, Tablas, etc.) */
        .container {
            max-width: 1400px;
            margin: 30px auto;
            padding: 0 20px;
                    ...
                    <?php if ($reservas->num_rows > 0): ?>
                        <?php while ($row = $reservas->fetch_assoc()): ?>
                            <tr style="<?php echo ($row['estado'] == 'Expirado') ? 'opacity:0.5; background:#f9f9f9;' : ''; ?>">
                                ...
                                <td>
                                    <div class="actions">
                                        <a href="https://wa.me/51<?php echo $row['telefono']; ?>?text=Hola <?php echo $row['nombres']; ?>, te escribimos de Rinconcito Marino..."
